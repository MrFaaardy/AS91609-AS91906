...
class EnvironmentView(arcade.View):
    ...
    def __init__(self):
        ...
        # Floor
        floor = arcade.SpriteSolidColor(SCREEN_WIDTH, 20, arcade.color.GREEN)
        floor.position = SCREEN_WIDTH // 2, 10
        ...
        # Ceiling
        ceiling = arcade.SpriteSolidColor(SCREEN_WIDTH, 20, arcade.color.GREEN)
        ceiling.position = SCREEN_WIDTH // 2, SCREEN_HEIGHT - 10
        ...
        # Left wall
        left_wall = arcade.SpriteSolidColor(20, SCREEN_HEIGHT, arcade.color.GREEN)
        left_wall.position = 10, SCREEN_HEIGHT // 2
        ...
        # Right wall
        right_wall = arcade.SpriteSolidColor(20, SCREEN_HEIGHT, arcade.color.GREEN)
        right_wall.position = SCREEN_WIDTH - 10, SCREEN_HEIGHT // 2
